	  	...
	  	<article>
			...
			<!-- Aside -->
		  	<aside class="clearfix">
				...
				<?php if (($params->get('show_author') && !empty($item->author )) or ($params->get('show_parent_category')) or ($params->get('show_category')) or ($params->get('show_create_date')) or ($params->get('show_publish_date')) ) : ?>
