...
<form id="adminForm" action="<?php echo JRoute::_('index.php')?>" method="post" class="form-inline">
	...
	<div class="filter-search alert alert-info">
		...
		<div class="form-group">
			...
			<input type="text" name="filter-search" id="filter-search" value="<?php echo $this->escape($this->filter); ?>" class="form-control col-sm-2" onchange="document.getElementById('adminForm').submit();" />
		</div>
		<?php endif; ?>
