...
<link rel="stylesheet" href="<?php echo T3V3_ADMIN_URL ?>/admin/tour/css/tour.css" type="text/css" />
<script type="text/javascript" src="<?php echo T3V3_URL ?>/js/jquery.ckie.js"></script>
<script type="text/javascript" src="<?php echo T3V3_URL ?>/bootstrap/js/bootstrap-popover.js"></script>
<script type="text/javascript" src="<?php echo T3V3_ADMIN_URL ?>/admin/tour/js/tour.js"></script>
...
<div id="t3-tour-quickhelp" class="t3-tour-quickhelp hide">
	<div><?php echo JTexT::_('T3V3_TOUR_QUICK_HELP') ?></div>
</div>
...
<script type="text/javascript">
	...
	T3v3Tours.tours = [
		{
			...
			highlighter: "", 
			monitor	: "",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_1_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_1_CONTENT')) ?>,
		...
		},
		{
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_2_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_2_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_2')) ?>
		},
		{
			id		: '3',
			element : "#ja_styles_list_chzn",
			position: "bottom",
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_3_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_3_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_3')) ?>
		},
		{
			id		: '4',
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_4_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_4_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_4')) ?>,
		},
		{
			id		: '5',
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_5_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_5_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_4')) ?>,
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_6_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_6_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_4')) ?>,
			beforeShow	: function() {jQuery('.t3-admin-nav ul li:eq(0) a').tab ('show')}
		},
		{
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_7_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_7_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		...
		},
		{
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_8_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_8_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		},
		{
			id		: '9',
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_9_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_9_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		},
		{
			id		: '10',
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_10_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_10_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		},
		{
			id		: '11',
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_11_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_11_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		...
		},
		{
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_12_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_12_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		},
		{
			id		: '13',
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_13_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_13_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		},
		{
			id		: '14',
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_14_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_14_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		...
		},
		{
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_15_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_15_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		},
		{
			id		: '16',
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_21_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_21_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_20_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_20_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_22_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_22_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		...
		},
		{
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_23_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_23_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		},
		{
			id		: '20',
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_16_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_16_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		},
		{
			id		: '21',
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_17_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_17_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		...
		},
		{
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_18_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_18_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
		},
		{
			id		: '23',
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_19_TITLE')) ?>,
		...
		},
		{
			...
			highlighter: "", 
			monitor	: "mouseover",
			title	: <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_29_TITLE')) ?>,
			text    : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_29_CONTENT')) ?>,
			dismiss : <?php echo json_encode(JText::_('T3V3_TOUR_GUIDE_DISMISS_1')) ?>,
			beforeShow : function() {jQuery('#jform_params_mm_enable1').prop('checked', true).trigger('update').trigger('change')}
		},
	];
	...
	T3v3Tours.plays = [
		{
			...
			tour: ["8", "9", "10"],
			/*intro	: <?php echo json_encode(JText::_('T3V3_TOUR_INTRO_TOUR1')) ?>*/
		},
		{
			when: function() {return jQuery('.t3-admin-nav ul li:eq(2)').hasClass('active');},
			tour: ["12", "13"],
			/*intro	: <?php echo json_encode(JText::_('T3V3_TOUR_INTRO_TOUR2')) ?>*/
		},
		{
			when: function() {return jQuery('.t3-admin-nav ul li:eq(3)').hasClass('active');},
			tour: ["15", "16", "17", "18", "19"],
			/*intro	: <?php echo json_encode(JText::_('T3V3_TOUR_INTRO_TOUR3')) ?>*/
		},
		{
	...
	jQuery(document).ready(function($) {
		if(!T3v3Tours.init){
			...
			$(document.body).t3tour(T3v3Tours);
			T3v3Tours.init = true;
		}

		// integrate with help button
		$('#t3-toolbar-help').on('click', function(){
			if(typeof T3v3Tours != 'undefined'){
