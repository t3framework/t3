...
<div class="home">
  ...
  <!-- HOME SL 1 -->
  <section class="wrap ja-sl ja-sl-1<?php $this->_c('home-1')?>">
  ...
  <!-- HOME SL 2 -->
  <section class="container ja-sl ja-sl-2<?php $this->_c('home-2')?>">
  ...
  <!-- HOME SL 3 -->
  <section class="container ja-sl ja-sl-3<?php $this->_c('home-3')?>">
  ...
  <!-- HOME SL 4 -->
  <section class="container ja-sl ja-sl-4<?php $this->_c('home-4')?>">
  ...
  <!-- HOME SL 5 -->
  <section class="wrap ja-sl ja-sl-5<?php $this->_c('home-5')?>">
